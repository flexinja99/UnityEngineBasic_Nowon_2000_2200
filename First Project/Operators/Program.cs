...
namespace Operators
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // or
            // a 와 b 둘 중 하나라도 true면 true 반환, 나머지경우 false 반환 
            Console.WriteLine(A | B);

            // and
            // a 와 b 둘 다 true면 true 반환, 나머지경우 false 반환
            Console.WriteLine(A & B);

            // xor
            // a 와 b 둘 중 하나만 ture면 true 반환, 나머지경우 false 반환
            Console.WriteLine(A ^ B);

            // not
            // 피연산자가 ture면 false, false면 true 반환
            Console.WriteLine(!A);
