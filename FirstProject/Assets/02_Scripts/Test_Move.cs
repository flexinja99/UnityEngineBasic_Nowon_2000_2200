...
public class Test_Move : MonoBehaviour
{
    ...
    // Initialization 함수들
    // 본 클래스를 컴포넌트로 가지는 게임오브젝트가 활성화되어있을때만 한번 호출됨
    ...
    private void Awake()
    {
        ...
        // Test_Mover 컴포넌트가 가지는 게임오브젝트가 가지고있는
    ...
    void Start()
    {
        // 다른 GameObject 의 컴포넌트 인스턴스 등 외부 참조를 해서 초기화 해야할 때
        // Awake() 에서 다 초기화 된 후에 실행 되어야 할 때.
    }
